            ...
            <?php if ($cine->listarTodosEventosCine() != null || $cine->listarTodosEventosCine() != false) {
              foreach ($cine->listarTodosEventosCine() as $data) { ?>
                <tr>
                  ...
                  <td
                    style="text-align:center;width:100;vertical-align:middle"><?= $data['programacao_regular'] ?></td>
                  <td style="text-align:center;width:100;vertical-align:middle"><?= $data['projetos'] ?></td>
